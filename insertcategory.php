...
if (strlen($_POST['name']) >= 3){
    try {
        ...
        $stmt->execute();
        $_SESSION['msg'] = "Категория инструмента успешно добавлена";
        // return generated id
...
else $_SESSION['msg'] = "Ошибка добавления категории инструмента: категория инструмента должна содержать не менее 3х символов";
